...
Os principais destinos nos oito meses do ano foram o Reino Unido (28,96\%), a Holanda (27,33\%) e os Estados Unidos (19,93\%). A principal via de envio foi a maritima (85,11\%) e os principais estados de origem da uva foram Pernambuco (60,69%) e Bahia (35,17\%). Em `r strftime(atual, format = "%B")`, cerca de 43,5 t de uva foram importadas do Chile e 56,1 t do Peru.
