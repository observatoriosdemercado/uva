...
Em relação aos volumes, em `r strftime(atual, format = "%B de %Y")` foram de 10.890 toneladas (t). A média histórica (até 2020) para este mês é de 3.472 t. Em `r strftime(atual, format = "%B")` de 2021 foram exportadas 9.363 t e, em `r strftime(atual, format = "%B")` de 2022, foram 9.284 t, ou seja, houve um aumento de 16,3\% em relação a 2021, e de 17,30\% na comparação com o mesmo período de 2021. No ano, foram exportadas cerca de 73,2 mil t, um aumento de 39,29\% em relação ao mesmo período de 2022. Contudo, ficou 4,43% abaixo do recorde histórico de 2021.

Em termos dos valores da exportações, em `r strftime(atual, format = "%B de %Y")` foram cerca de 24,8 milhões de dólares (US\$). A média histórica (até 2020) para este mês é de aproximadamente US\$ 7,68 milhões. Em `r strftime(atual, format = "%B")` de 2021 foram gerados US\$ 17,6 milhões em receitas e, em `r strftime(atual, format = "%B")` de 2022, um total de US\$ 19,9 milhões. No ano, as receitas são recorde histórico, cerca de US\$ 178,3 milhões, superando o valor de US\$ 159,6 milhões de 2021. 

Os principais destinos no ano foram a Holanda (36,68\%), os Estados Unidos (26,67\%), o Reino Unido (20,98\%) e a Espanha (5,71\%). A principal via de envio foi a maritima (95,87\%) e os principais estados de origem da uva foram Pernambuco (68,32%) e Bahia (30,36\%). No ano, cerca de 6,1 mil t de uvas foram importadas do Chile; 1,1 mil t do Peru e 401 t da Argentina.
...
g4 <- ggplot()+
  ...
  geom_line(data=tablea2, aes(x=Meses, y=value, colour=variable), linetype = "solid",
    ...
    scale_y_continuous(limits = c(0, 65000), n.breaks = 10)+
    scale_x_date(date_breaks = "1 month",
               labels = date_format("%B"))+
