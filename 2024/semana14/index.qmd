...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 15,68, variando entre R\$17,00 e R\$13,60. Este valor é maior do que o máximo histórico deflacionado encontrado na semana `r strftime(today, format = "%V")` de 2023, que foi R\$ 13,77. Em 2022 o preço foi R$ 10,18. Em relação a semana `r strftime(last, format = "%V")`, houve uma queda de -1,88% nos preços.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 12,65, variando entre R\$ 15,00 e R\$ 11,00. Em 2022, o preço deflacionado é de R\$ 9,45. Em 2023, o preço é de R\$ 7,06 e a média histórica deflacionada para esta semana é de R\$ 11,32. Depois de quatro semanas, os preços voltam a ficar acima da média histórica da semana. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 19,34%.

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` é R\$9,25, variando entre R\$10,00 e R\$8,50. Isto significa um aumento de 32,14% em relação à semana anterior. Este valor, é maior do que a máxima histórica deflacionada da semana (R\$6,96). Em 2022, a média é R\$5,10 e, em 2023, a média deflacionada é R\$3,56. Assim, os preços continuam acima da média histórica semanal.
