...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 15,83, variando entre R\$17,00 e R\$15,00. Este valor é maior do que o máximo histórico deflacionado encontrado na semana `r strftime(today, format = "%V")` de 2023, que foi R\$ 13,96. Em 2022 o preço foi R$ 11,52. Em relação a semana `r strftime(last, format = "%V")`, houve estabilidade nos preços.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 10,60, variando entre R\$ 11,00 e R\$ 10,40. Em 2022, o preço deflacionado é de R\$ 10,79. Em 2023, o preço é de R\$ 8,80 e a média histórica deflacionada para esta semana é de R\$ 12,24. É a terceira vez no ano que os preços ficam abaixo da média histórica da semana. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 2,42%.

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` é R\$7,00, sem variação. Isto significa um aumento de 10,58%. Este valor, além de maior do que a média histórica deflacionada da semana (R\$6,57) é maior do que a média de 2022 (R\$6,85) e que o preço de 2023 deflacionado (R\$5,23). Assim, após três semanas abaixo da média histórica, os preços voltam a ficar acima da mesma.
