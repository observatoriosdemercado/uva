...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 15,98, variando entre R\$17,00 e R\$14,40. Este valor é maior do que o máximo histórico deflacionado encontrado na semana `r strftime(today, format = "%V")` de 2023, que foi R\$ 13,99. Em 2022 o preço foi R$ 10,52. Em relação a semana `r strftime(last, format = "%V")`, houve um aumento de 0,95% nos preços.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 10,60, variando entre R\$ 11,20 e R\$ 9,60. Em 2022, o preço deflacionado é de R\$ 10,16. Em 2023, o preço é de R\$ 7,63 e a média histórica deflacionada para esta semana é de R\$ 11,67. É a quarta vez no ano que os preços ficam abaixo da média histórica da semana. Em relação à semana `r strftime(last, format = "%V")`, os preços ficaram estáveis.

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` é R\$7,00, sem variação. Isto significa uma estabilidade em relação à semana anterior. Este valor, além de maior do que a média histórica deflacionada da semana (R\$5,80) é maior do que a média de 2022 (R\$6,33) e que o preço de 2023 deflacionado (R\$3,81). Assim, os preços continuam acima da média histórica semanal.
