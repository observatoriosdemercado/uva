...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da uva é de 29.310 pessoas. No mesmo mês do ano passado, este valor era de 28.963, ou seja, existe um aumento do número de pessoas ocupadas na vitiicultura.
