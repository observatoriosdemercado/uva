...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da uva é de 30.326 pessoas. No mesmo mês do ano passado, este valor era de 30.552, ou seja, existe um queda do número de pessoas ocupadas na viticultura.

O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é positivo, de 1.002 pessoas, ou seja, o total de contratações (3.032) foi maior do que o total de demissões (2.030). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (1.583 em 2023 e 1.002 em 2024), pois o número de pessoas que conseguiram o emprego foi menor. 

Dos contratados no mês, 1.736 são do sexo feminino (57,26% do total) e 1.296 do sexo masculino (42,74%). Em relação à idade, 16,95% dos contratados tem até 21 anos, 14,54% até 24 anos, 11,15% até 27 anos e 8,97% até 30 anos.

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (1.199). Do total de contratados, 39,54% possuem este nível de escolaridade.

Com relação aos salários pagos, 91,26% dos contratados foram pelo valor de R\$ 1.450,00, acima do salário mínimo nacional, conforme acordo pela CCT 2024. O salário mais elevado foi R\$ 43.500,00.
