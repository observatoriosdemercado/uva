...
O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é de 295 pessoas, ou seja, o total de contratações (2.803) foi menor do que o total de demissões (2.508). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (-272 em 2023 e 295 em 2024), pois o número de pessoas que conseguiram o emprego foi maior. 

Dos contratados no mês, 1.261 são do sexo masculino (44,99% do total) e 1.542 do sexo feminino (55,01%). Em relação à idade, 14,98% dos contratados tem até 21 anos, 13,84% até 24 anos, 11,88% até 27 anos e 8,88% até 30 anos.

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (1.078). Do total de contratados, 38,46% possuem este nível de escolaridade.

Com relação aos salários pagos, 90,26% dos contratados foram pelo valor de R\$ 1.450,00, acima do salário mínimo nacional, conforme acordo pela CCT 2024. O salário mais elevado foi R\$ 8.021,00.
