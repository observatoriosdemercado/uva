...
O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é de 732 pessoas, ou seja, o total de contratações (2.464) foi menor do que o total de demissões (1.732). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (368 em 2023 e 732 em 2024), pois o número de pessoas que conseguiram o emprego foi maior. 

Dos contratados no mês, 1.142 são do sexo masculino (46,35% do total) e 1.322 do sexo feminino (53,65%). Em relação à idade, 15,34% dos contratados tem até 21 anos, 13,72% até 24 anos, 11,40% até 27 anos e 8,04% até 30 anos.

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (937). Do total de contratados, 38,03% possuem este nível de escolaridade.

Com relação aos salários pagos, 87,62% dos contratados foram pelo valor de R\$ 1.450,00, acima do salário mínimo nacional, conforme acordo pela CCT 2024. O salário mais elevado foi R\$ 12.000,00.
...
g5 <- ggplot(data=subclasse_positivos, aes(x=salario))+
  ...
  scale_x_continuous(limits=c(0, 12000), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
