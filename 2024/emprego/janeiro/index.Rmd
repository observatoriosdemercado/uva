...
O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é de -1.965 pessoas, ou seja, o total de contratações (1.640) foi menor do que o total de demissões (3.605). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (-1.579 em 2022 e -1.965 em 2023), pois o número de pessoas que perderam o emprego foi maior. 

Dos contratados no mês, 966 são do sexo masculino (58,90% do total) e 674 do sexo feminino. Em relação à idade, 13,72% dos contratados tem até 21 anos, 13,29% até 24 anos, 11,71% até 27 anos e 9,81% até 30 anos.

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (568). Do total de contratados, 34,63% possuem este nível de escolaridade.

Com relação aos salários pagos, 91,59% dos contratados foram pelo valor de R\$ 1.354,00, acima do salário mínimo nacional, conforme acordo pela CCT 2023. O salário mais elevado foi R\$ 6.000,00.
...
g5 <- ggplot(data=subclasse_positivos, aes(x=salario))+
  ...
  scale_x_continuous(limits=c(0, 6200), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
