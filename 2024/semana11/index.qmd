...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 15,83, variando entre R\$17,00 e R\$15,00. Este valor é maior do que o máximo histórico deflacionado encontrado na semana `r strftime(today, format = "%V")`, que foi R\$ 14,58. Em 2022 o preço foi R$ 12,13. Em relação a semana `r strftime(last, format = "%V")`, houve uma queda de -1,06% nos preços.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 10,35, variando entre R\$ 11,00 e R\$ 9,60. Em 2022, o preço deflacionado é de R\$ 10,55. Em 2023, o preço é de R\$ 10,54 e a média histórica deflacionada para esta semana é de R\$ 12,39. É a segunda vez no ano que os preços ficam abaixo da média histórica da semana. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -11,54%.

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` é R\$6,33, variando entre R\$7,00 e R\$6,00. Isto significa um aumento depois de quatro quedas consecutivas, de 8,58%. Este valor, além de menor do que a média histórica deflacionada da semana (R\$7,07) é menor do que a média de 2022 (R\$7,08) e que o preço de 2023 deflacionado (R\$6,98).
