...
Os dados utilizados nesta análise são semanais e disponibilizados pelo **CEPEA (Esalq-USP)** englobando o período de 2017 a 2024, de uva sem semente branca e negra embaladas (incluso uva+material de embalagem+resfriamento, FOB-Petrolina), para os produtores do Vale do São Francisco. Também mostra informações sobre a uva negra sem embalagem, com dados semanais de 2019 à 2024. Os preços até a semana `r strftime(today, format = "%V de %Y")`, deflacionados pelo IGP-DI, são comparados com a média de cada semana entre 2017 e 2023, mínimo e máximo. Os preços deflacionados de 2022 e de 2023 também são apresentados para comparação de 2024 com os dois anos anteriores.

O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 16,36, variando entre R\$18,00 e R\$14,50. Este valor é maior do que o máximo histórico deflacionado, que foi R\$ 14,64. Em 2022, o preço foi R\$ 11,73 e, em 2023, R\$ 13,01. Em relação a semana `r strftime(last, format = "%V")`, houve uma queda de -4,44% nos preços. A quarta semana seguida com queda de preços.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 7,67, variando entre R\$ 8,00 e R\$ 7,00. Em 2022, o preço deflacionado é de R\$ 9,04. Em 2023, o preço é de R\$ 10,24 e a média histórica deflacionada para esta semana é de R\$ 9,72. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -2,66%. A quarta semana seguida com queda de preços.

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` é R\$4,17, variando entre R\$ 4,50 e R\$ 4,00, uma diminuição de -18,80% em relação à semana anterior. Este valor é menor do que a mínima histórica deflacionada semanal (R\$ 4,30). Em 2022, a média deflacionada é R\$5,82 e, em 2023, é R\$6,51. A primeira vez no ano que os preços ficam abaixo da mínima histórica da semana.
...
preco_vitoria4 <- window(preco_vitoriase, start=c(2024,1), end=c(2024,26), freq=52)
```
...
g1 <- ggplot(data=arra, aes(x=date)) +  #estetica vai valer para todos os geom's
  ...
  scale_y_continuous(limits=c(0,19), n.breaks = 10, expand = expansion(add=c(0,0.5)), 
