...
Os principais destinos foram a Holanda (50,1%), o Reino Unido (15,78%) e o Canadá (12,39%). A principal via de envio foi a maritima (96,36%), com 89,7% do total despachado pela alfândega de Fortaleza. Os principais estados de origem da uva foram Pernambuco (65,95%) e Bahia (31,64%). Em `r strftime(atual, format = "%B de %Y")` foram importadas 819 t de uvas do Chile, 292 t da Argentina e 54 t do Peru.
