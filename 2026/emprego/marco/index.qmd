...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da uva é de 29.266 pessoas. No mesmo mês do ano passado, este valor era de 29.182, ou seja, ocorreu um aumento do número de pessoas ocupadas na viticultura de 0,29%, nesta comparação.

O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é negativo, de -345 pessoas, ou seja, o total de contratações (1.933) foi menor do que o total de demissões (2.278). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (-351 em 2025 e -345 em 2026), pois o número de pessoas que mantiveram o emprego foi maior. 

Dos contratados no mês, 894 são do sexo masculino (46,25% do total) e 1.039 do sexo feminino (53,75%). Em relação à idade, 13,19% dos contratados tem até 21 anos, 13,14% até 24 anos, 11,23% até 27 anos e 9,98% até 30 anos.

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (984). Do total de contratados, 50,91% possuem este nível de escolaridade.

Com relação aos salários pagos, 52,61% dos contratados foram pelo valor de R\$ 1.621,00, o salário mínimo nacional. Além disso, 33,73% foram pelo valor de R\$ 1.664,00, que é o novo piso salarial para a categoria, resultado da 32 CCT da Fruticultura irrigada para o ano de 2026.   
