...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da uva é de 28.617 pessoas. No mesmo mês do ano passado, este valor era de 28.505, ou seja, ocorreu um aumento do número de pessoas ocupadas na viticultura.

O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é negativo, de -355 pessoas, ou seja, o total de contratações (2.407) foi menor do que o total de demissões (2.742). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (-58 em 2024 e -335 em 2024), pois o número de pessoas que mantiveram o emprego foi menor. 

Dos contratados no mês, 1.104 são do sexo masculino (45,87% do total) e 1.303 do sexo feminino (54,13%). Em relação à idade, 15,70% dos contratados tem até 21 anos, 13,21% até 24 anos, 10,51% até 27 anos e 8,23% até 30 anos.

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (996). Do total de contratados, 41,38% possuem este nível de escolaridade.

Com relação aos salários pagos, 73,70% dos contratados foram pelo valor de R\$ 1.518,00, acima do salário mínimo nacional. O salário mais elevado foi R\$ 10.500,00.
...
#Entrando dados no R
dados2 <- read.csv2('estoque_janeiro25.csv', header=T, sep=";")
