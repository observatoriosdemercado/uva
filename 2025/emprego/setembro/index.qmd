...
lang: pt
language: 
  toc-title-document: '<a href="https://observatoriosdemercado.github.io/uva/" target="_blank"><img src="https://raw.githubusercontent.com/observatoriosdemercado/manga/refs/heads/main/logo_embrapa.jpg" alt="Logotipo Embrapa" width="150"></a>'
format: 
  html:
    toc: true
    toc_float:
...
Em `r strftime(atual, format = "%B de %Y")`, o Estoque de empregos na cultura da uva é de 32.502 pessoas. No mesmo mês do ano passado, este valor era de 31.998, ou seja, ocorreu um aumento do número de pessoas ocupadas na viticultura de 1,57%, nesta comparação.

O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é positivo, de 562 pessoas, ou seja, o total de contratações (2.747) foi maior do que o total de demissões (2.185). Em relação ao mesmo mês do ano passado, se tem uma redução no saldo total (1.659 em 2024 e 562 em 2025), pois o número de pessoas que mantiveram o emprego foi menor. 

Dos contratados no mês, 1.533 são do sexo feminino (55,81% do total) e 1.214 do sexo masculino (44,19%). Em relação à idade, 16,42% dos contratados tem até 21 anos, 12,85% até 24 anos, 9,68% até 27 anos e 7,93% até 30 anos.

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (1.240). Do total de contratados, 45,14% possuem este nível de escolaridade.

Com relação aos salários pagos, 85,04% dos contratados foram pelo valor de R\$ 1.555,00 (valor definido no CCT 2025), mais alto que o salário mínimo nacional. O maior salário foi R$ 77.750,00. 
