...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 16,03, variando entre R\$17,00 e R\$15,00. Este valor é maior do que a média histórica deflacionada, que foi R\$ 12,34. Em 2023, o preço foi R\$ 9,13 e, em 2024, R\$ 18,45. Em relação a semana `r strftime(last, format = "%V")`, houve um redução de -4,13% nos preços. 

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 6,96, variando entre R\$ 7,60 e R\$ 5,60. Em 2023, o preço deflacionado é de R\$ 8,76. Em 2024, o preço é de R\$ 12,06 e a média histórica deflacionada para esta semana é de R\$ 10,42. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -0,57%. É a sexta semana consecutiva que os preços caem, se aproximando do valor mínimo histórico (R\$6,26)

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` é R\$ 4,08, variando entre R\$ 4,50 e R\$ 4,00, uma queda de -5,12% em relação à semana anterior. É a oitava queda de preços, em nove semanas. O preço médio da semana é menor do que o preço de  2023 (R\$5,16) e do que a média histórica deflacionada semanal (R\$ 5,50) e menos do que a metade do preço de 2024, R\$ 8,47.
