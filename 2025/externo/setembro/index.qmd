...
Em relação aos volumes, em `r strftime(atual, format = "%B de %Y")` foram de 4.747 toneladas (t). A média histórica (até 2024) para este mês é de 3.307 t. Em `r strftime(atual, format = "%B")` de 2023 foram exportadas 3.388 t e, em `r strftime(atual, format = "%B")` de 2024, foram 3.171 t, ou seja, houve um aumento de 40,11% em relação a 2023 e de 49,70% na comparação com o mesmo período de 2024. No ano, foram exportadas 17,2 mil t, aumento de 80,16% em relação à 2024.

Sobre o mercado norte americano, que impôs tarifas de 50% sobre a uva do Brasil, no ano foram exportadas 1.952 t. Em 2024, no mesmo período, foram 3.609 t. Considerando apenas o mes de setembro, em 2025 foram exportadas 277 t de mangas, uma redução de -69,24% na comparação com 2024, onde foram exportadas 901 t.

Em termos dos valores das exportações, em `r strftime(atual, format = "%B de %Y")` foram cerca de US\$ 12,2 milhões de dólares. A média histórica (até 2024) para este mês é de aproximadamente US\$ 7,81 milhÕes. Em `r strftime(atual, format = "%B")` de 2023 foram gerados US\$ 10 milhões em receitas e, em `r strftime(atual, format = "%B")` de 2024, um total de US\$ 10,4 milhões. No ano, as receitas chegam a US$ 43,9 milhões, aumento de 53,6% em relação à 2024.

Os principais destinos foram a Argentina (29,97%), a Holanda (27,82%), o Reino Unido (23,07%) e os Estados Unidos (11,37%). A principal via de envio foi a maritima (66,49%), com 39% do total despachado pela alfândega de Fortaleza e 27,89% pela de Salvador.

Os principais estados de origem da uva foram Pernambuco (59,89%) e Bahia (34,62%). Em `r strftime(atual, format = "%B de %Y")`, cerca de 94,9 t de uvas foram importadas do Peru.
...
dados21$URF <- factor(dados21$URF, levels = c("ALF-Fortaleza", "ALF-Salvador", "ALF-Foz do Iguaçu", "ALF-Dionísio Cerqueira", "ALF-Corumbá", "IRF-Chuí", "Aeroporto de GRU", "IRF-Santana do Livramento",  "Outros"))
