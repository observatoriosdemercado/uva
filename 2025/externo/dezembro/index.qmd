...
Em relação aos volumes, em `r strftime(atual, format = "%B de %Y")` foram de 6.295 toneladas (t). A média histórica (até 2024) para este mês é de 6.895 t. Em `r strftime(atual, format = "%B")` de 2023 foram exportadas 10.890 t e, em `r strftime(atual, format = "%B")` de 2024, foram 15.156 t, ou seja, houve uma redução de -42,19% em relação a 2023 e uma queda -58,46% na comparação com o mesmo período de 2024. No ano, foram exportadas 62,2 mil t, aumento de 5,66% em relação à 2024.

Sobre o mercado norte americano, que impôs tarifas de 50% sobre a uva do Brasil, no ano foram exportadas 4.159 t. Em 2024, no mesmo período, foram 13.825 t. Isto significa uma redução de -69,9% na comparação dos dois anos.

Em termos dos valores das exportações, em `r strftime(atual, format = "%B de %Y")` foram cerca de US\$ 15 milhões de dólares, valor muito próximo da média histórica. Em `r strftime(atual, format = "%B")` de 2023 foram gerados US\$ 25,6 milhões em receitas e, em `r strftime(atual, format = "%B")` de 2024, um total de US\$ 36,2 milhões. No ano, as receitas foram de US$ 158,6 milhões, praticamente o mesmo valor de 2024.  Assim, como os produtores/exportadores enviaram mais frutas, isto significa que os preços obtidos foram menores. 

Os principais destinos foram a Holanda (44,97%), o Reino Unido (23,94%), a Argentina (12,87%) e os Estados Unidos (6,7%). A principal via de envio foi a maritima (85,85%), com 47,57% do total despachado pela alfândega de Salvador e 38,06% pela de Fortaleza. Os principais estados de origem da uva foram Pernambuco (68,44%) e Bahia (29,12%). Em 2025 foram importadas 8,9 mil toneladas de uvas, praticamente o mesmo valor de 2024.
...
dados21$URF <- factor(dados21$URF, levels = c("ALF-Salvador", "ALF-Fortaleza", "ALF-Foz do Iguaçu", "ALF-Dionísio Cerqueira", "ALF-Corumbá", "IRF-Natal", "IRF-Chuí", "IRF-Santana do Livramento", "Aeroporto de GRU", "Outros"))
