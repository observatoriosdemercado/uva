...
Em relação aos volumes, em `r strftime(atual, format = "%B de %Y")` foram de 22.092 toneladas (t). A média histórica (até 2024) para este mês é de 15.923 t. Em `r strftime(atual, format = "%B")` de 2023 foram exportadas 26.574 t e, em `r strftime(atual, format = "%B")` de 2024, foram 17.161 t, ou seja, houve um aumento de 28,73% em relação a 2024 e uma queda -16,87% na comparação com o mesmo período de 2023. No ano, foram exportadas 55,9 mil t, aumento de 27,90% em relação à 2024.

Sobre o mercado norte americano, que impôs tarifas de 50% sobre a uva do Brasil, no ano foram exportadas 3.966 t. Em 2024, no mesmo período, foram 9.252 t. Considerando apenas o mês de novembro, em 2025 foram exportadas 1.374 t de uvas, uma redução de -67,80% na comparação com 2024, onde foram exportadas 4.266 t.

Em termos dos valores das exportações, em `r strftime(atual, format = "%B de %Y")` foram cerca de US\$ 54 milhões de dólares. A média histórica (até 2024) para este mês é de aproximadamente US\$ 35,9 milhões. Em `r strftime(atual, format = "%B")` de 2023 foram gerados US\$ 65,9 milhões em receitas e, em `r strftime(atual, format = "%B")` de 2024, um total de US\$ 44,8 milhões. No ano, as receitas chegam a US$ 140,6 milhões, aumento de 14,73% em relação à 2024.

Os principais destinos foram a Holanda (42,88%), o Reino Unido (24,99%), a Argentina (13,75%) e os Estados Unidos (7,1%). A principal via de envio foi a maritima (84,83%), com 48,51% do total despachado pela alfândega de Salvador e 36,16% pela de Fortaleza. Os principais estados de origem da uva foram Pernambuco (68,30%) e Bahia (29,11%). Em `r strftime(atual, format = "%B de %Y")`, cerca de 43,8 t de uvas foram importadas do Peru.
...
dados21$URF <- factor(dados21$URF, levels = c("ALF-Salvador", "ALF-Fortaleza", "ALF-Foz do Iguaçu", "ALF-Dionísio Cerqueira", "ALF-Corumbá", "IRF-Chuí", "IRF-Natal", "IRF-Santana do Livramento", "Aeroporto de GRU", "Outros"))
