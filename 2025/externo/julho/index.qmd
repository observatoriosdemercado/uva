...
Em relação aos volumes, em `r strftime(atual, format = "%B de %Y")` foram de 1.214 toneladas (t). A média histórica (até 2024) para este mês é de 422 t. Em `r strftime(atual, format = "%B")` de 2023 foram exportadas 748 t e, em `r strftime(atual, format = "%B")` de 2024, foram 538 t, ou seja, houve um aumento de 62,30% em relação a 2023 e de 125,65% na comparação com o mesmo período de 2024. No ano, foram exportadas 11,6 mil t, aumento de 109,3% em relação à 2024.

Em termos dos valores das exportações, em `r strftime(atual, format = "%B de %Y")` foram cerca de US\$ 2,53 milhões de dólares. A média histórica (até 2024) para este mês é de aproximadamente US\$ 825 mil. Em `r strftime(atual, format = "%B")` de 2023 foram gerados US\$ 1,64 milhões em receitas e, em `r strftime(atual, format = "%B")` de 2024, um total de US\$ 1,24 milhões. No ano, as receitas chegam a US$ 29,3 milhões, aumento de 82% em relação à 2024.

Os principais destinos foram a Holanda (31,17%), o Reino Unido (25,62%), a Argentina (22,27%) e os Estados Unidos (14,29%). A principal via de envio foi a maritima (73,68%), com 48,95% do total despachado pela alfândega de Fortaleza e 25,51% pela de Salvador.

Os principais estados de origem da uva foram Pernambuco (61,41%) e Bahia (33,94%). Em `r strftime(atual, format = "%B de %Y")`, cerca de 132 t de uvas foram importadas do Chile e 42 t do Peru.
...
dados21$URF <- factor(dados21$URF, levels = c("ALF-Fortaleza", "ALF-Salvador", "ALF-Foz do Iguaçu", "ALF-Dionísio Cerqueira", "Aeroporto de GRU", "IRF-Chuí", "IRF-Santana do Livramento", "ALF-Corumbá", "Outros"))
