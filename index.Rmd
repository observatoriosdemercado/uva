...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 11,09, variando entre R\$11,25 e R\$11,00. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$12,31), menor que o valor deflacionado de 2020 (R\$14,11), mas é maior do que o valor de 2021 (R\$10,16). Em relação a semana `r strftime(last, format = "%V")` houve um aumento de 5,12%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $8,32 variando entre R\$ 10,00 e R\$ 7,00. Em 2020, o preço deflacionado é de R\$ 10,37. Em 2021, o preço é de R\$ 7,93 e a média histórica deflacionada para esta semana é de R\$ 11,48. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -8,37%. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` diminuiu em relação a semana anterior (-10,67%), na média de R\$4,02, variando entre R\$4,50 e R\$3,50. Este valor é maior do que o de 2021 deflacionado (R\$ 3,88), mas é mais baixo do que o valor de 2020 (R\$ 6,60), e que a média histórica deflacionada da semana (R\$ 6,47).
