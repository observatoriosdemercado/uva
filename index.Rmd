...
date2 <- seq(as.Date('2022-01-01'),to=as.Date('2022-12-01'),by='1 month')

#Entrando dados no R
dados <- read_excel("uva_ibge2022.xlsx", col_names = TRUE)
...
### Área Plantada com Uva no Brasil em 2022 
``` {r}
num <- 29.568 
valueBox(
...
### Produtividade média da Uva no Brasil em 2022 
``` {r}
num <- 24
valueBox(
...
### Volume com Uva produzida no Brasil em 2022 
``` {r}
num <- 715.8
valueBox(
...
### VBP com Uva produzida no Brasil em 2022 
``` {r}
num <- 3.3
valueBox(
...
### Evolução da Area com uva no Brasil: 2013:2022 {.no-title}
...
g1 <- dados %>% 
  ...
  labs(y= "Hectares", x= "Anos", title='Evolução da Area com Uva no Brasil: 2013-2022',
...
### Evolução do Volume com uva no Brasil: 2013-2022 {.no-title}
...
g2 <- dados %>% 
  ...
  labs(y= "Mil Toneladas", x= "Anos", title='Evolução do Volume de Uva no Brasil: 2013-2022',
       caption = "Fonte: IBGE (2023)") +
...
g3 <- dados %>% 
  ...
  labs(y= "Produtividade (Ton/Ha)", x= "Anos", title='Evolução da Produtividade da Uva no Brasil: 2013-2022',
       caption = "Fonte: IBGE (2023)") +
...
### Evolução do Valor Bruto da Produção com uva no Brasil: 2013-2022  {.no-title}
...
g4 <- dados %>% 
  ...
  labs(y= "VBP (Milhões R$)", x= "Anos", title='Evolução do Valor Bruto da Produção da Uva no Brasil: 2013-2022',
       caption = "Fonte: IBGE (2023)") +
  scale_y_continuous(limits=c(0, 3400), n.breaks = 5, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2013, 2022, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
### Área Plantada com Uva no Vale S. Francisco em 2022 
``` {r}
num <- 11.114 
valueBox(
  value = paste0(num, " Hectares"),
...
### Produtividade média da Uva no Vale S. Francisco em 2022 
``` {r}
num <- 36
valueBox(
  value = paste0( num, " Toneladas/Hectare"),
...
### Volume com Uva produzida no Vale S. Francisco em 2022 
``` {r}
num <- 396.7
valueBox(
  value = paste0(format(num, decimal.mark =  ","), " Mil Toneladas" ),
...
### VBP com Uva produzida no Vale S. Francisco em 2022 
``` {r}
num <- 1.95
valueBox(
  value = paste0(format(num, decimal.mark =  ","), " Bilhões de Reais" ),
...
### Evolução da Area com uva no Vale do São Francisco: 2013:2022 {.no-title}

```{r ibge1b}
g1 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=area, fill="Area uva (Hectares)"), lwd=1)+
  scale_fill_manual(values=mycolor1)+
  labs(y= "Hectares", x= "Anos", title='Evolução da Area com Uva no Vale do São Francisco: 2013-2022',
       caption = "Fonte: IBGE (2023)") +
...
### Evolução do Volume com uva no Vale do São Francisco: 2013-2022 {.no-title}

```{r ibge2b}
g2 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=quantidade/1000, fill="Volume (Mil Toneladas)"), lwd=1)+
  scale_fill_manual(values=mycolor2)+
  labs(y= "Mil Toneladas", x= "Anos", title='Evolução do Volume de Uva no Vale do São Francisco: 2013-2022',
       caption = "Fonte: IBGE (2023)") +
  scale_y_continuous(limits=c(0, 520), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2013, 2022, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
### Evolução da Produtividade com uva no Vale do São Francisco: 2013-2022 {.no-title}

```{r ibge3b}
g3 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=produtividade, fill="Produtividade (Toneladas/Hectares)"), lwd=1)+
  scale_fill_manual(values=mycolor3)+
  labs(y= "Produtividade (Ton/Ha)", x= "Anos", title='Evolução da Produtividade da Uva no Vale do São Francisco: 2013-2022',
       caption = "IBGE (2023)") +
  scale_y_continuous(limits=c(0, 52), n.breaks = 5, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2013, 2022, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
### Evolução do Valor Bruto da Produção com uva no Vale do São Francisco: 2013-2022  {.no-title}

```{r ibge4b}
g4 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=vbp/1000, fill="Valor Bruto Produção (Milhões R$)"), lwd=1)+
  scale_fill_manual(values=mycolor4)+
  labs(y= "VBP (Milhões R$)", x= "Anos", title='Evolução do Valor Bruto da Produção da Uva no Vale do São Francisco: 2013-2022',
       caption = "IBGE (2023)") +
  scale_y_continuous(limits=c(0, 2000), n.breaks = 5, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2013, 2022, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
