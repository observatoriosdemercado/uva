...
date2 <- seq(as.Date('2023-01-01'),to=as.Date('2023-12-01'),by='1 month')

#Entrando dados no R
dados <- read_excel("uva_ibge2023.xlsx", col_names = TRUE)
...
### Área Plantada com Uva no Brasil em 2023 
``` {r}
num <- 30.029 
valueBox(
...
### Produtividade média da Uva no Brasil em 2023 
``` {r}
num <- 28
valueBox(
...
### Volume com Uva produzida no Brasil em 2023 
``` {r}
num <- 853.1
valueBox(
...
### VBP com Uva produzida no Brasil em 2023 
``` {r}
num <- 3.55
valueBox(
...
### Evolução da Area com uva no Brasil: 2014-2023 {.no-title}
...
g1 <- dados %>% 
  ...
  labs(y= "Hectares", x= "Anos", title='Evolução da Area com Uva no Brasil: 2014-2023',
       caption = "Fonte: IBGE (2024)") +
  scale_y_continuous(limits=c(0, 31000), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
...
### Evolução do Volume com uva no Brasil: 2013-2023 {.no-title}
...
g2 <- dados %>% 
  ...
  labs(y= "Mil Toneladas", x= "Anos", title='Evolução do Volume de Uva no Brasil: 2014-2023',
       caption = "Fonte: IBGE (2024)") +
...
### Evolução da Produtividade com uva no Brasil: 2013-2022 {.no-title}
...
g3 <- dados %>% 
  ...
  labs(y= "Produtividade (Ton/Ha)", x= "Anos", title='Evolução da Produtividade da Uva no Brasil: 2014-2023',
       caption = "Fonte: IBGE (2024)") +
...
### Evolução do Valor Bruto da Produção com uva no Brasil: 2014-2023  {.no-title}
...
g4 <- dados %>% 
  ...
  labs(y= "VBP (Milhões R$)", x= "Anos", title='Evolução do Valor Bruto da Produção da Uva no Brasil: 2014-2023',
       caption = "Fonte: IBGE (2024)") +
  scale_y_continuous(limits=c(0, 3600), n.breaks = 5, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2014, 2023, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
### Área Plantada com Uva no Vale S. Francisco em 2023 
``` {r}
num <- 12.294 
valueBox(
  value = paste0(num, " Hectares"),
...
### Produtividade média da Uva no Vale S. Francisco em 2023 
``` {r}
num <- 45
valueBox(
  value = paste0( num, " Toneladas/Hectare"),
...
### Volume com Uva produzida no Vale S. Francisco em 2023 
``` {r}
num <- 554
valueBox(
  value = paste0(format(num, decimal.mark =  ","), " Mil Toneladas" ),
...
### VBP com Uva produzida no Vale S. Francisco em 2023 
``` {r}
num <- 2.21
valueBox(
  value = paste0(format(num, decimal.mark =  ","), " Bilhões de Reais" ),
...
### Evolução da Area com uva no Vale do São Francisco: 2014-2023 {.no-title}

```{r ibge1b}
g1 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=area, fill="Area uva (Hectares)"), lwd=1)+
  scale_fill_manual(values=mycolor1)+
  labs(y= "Hectares", x= "Anos", title='Evolução da Area com Uva no Vale do São Francisco: 2014-2023',
       caption = "Fonte: IBGE (2024)") +
  scale_y_continuous(limits=c(0, 13000), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2014, 2023, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
### Evolução do Volume com uva no Vale do São Francisco: 2014-2023 {.no-title}

```{r ibge2b}
g2 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=quantidade/1000, fill="Volume (Mil Toneladas)"), lwd=1)+
  scale_fill_manual(values=mycolor2)+
  labs(y= "Mil Toneladas", x= "Anos", title='Evolução do Volume de Uva no Vale do São Francisco: 2014-2023',
       caption = "Fonte: IBGE (2024)") +
  scale_y_continuous(limits=c(0, 560), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2014, 2023, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
### Evolução da Produtividade com uva no Vale do São Francisco: 2014-2023 {.no-title}

```{r ibge3b}
g3 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=produtividade, fill="Produtividade (Toneladas/Hectares)"), lwd=1)+
  scale_fill_manual(values=mycolor3)+
  labs(y= "Produtividade (Ton/Ha)", x= "Anos", title='Evolução da Produtividade da Uva no Vale do São Francisco: 2014-2023',
       caption = "IBGE (2024)") +
...
### Evolução do Valor Bruto da Produção com uva no Vale do São Francisco: 2014-2023  {.no-title}

```{r ibge4b}
g4 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=vbp/1000, fill="Valor Bruto Produção (Milhões R$)"), lwd=1)+
  scale_fill_manual(values=mycolor4)+
  labs(y= "VBP (Milhões R$)", x= "Anos", title='Evolução do Valor Bruto da Produção da Uva no Vale do São Francisco: 2014-2023',
       caption = "IBGE (2024)") +
...
seas23 <- seasplot(preco_arra_2023, trend=F, outplot = F)
...
time <- seq(1:52)
table <- data.frame(time, matrix[,1], round(medias23,2), matrix[,2], round(tail(preco_arra_2022,52),2),
...
### Mínimo, Máximo, Media e preços de 2021 a 2024 de Uva Branca Embalada {.no-title}
...
g1 <- ggplot()+
  ...
  scale_y_continuous(limits = c(0, 19), n.breaks = 10, labels = number_format(accuracy = 0.01,
                                                       decimal.mark = ","))+
...
### Variação Semanal em 2024 e 2023 de Uva Branca Embalada {.no-title}
...
seas23 <- seasplot(preco_vitoria_2023, trend=F, outplot = F)
medias23 <- colMeans(seas23$season)
...
time <- seq(1:52)
table <- data.frame(time, matrix[,1], round(medias23,2), matrix[,2], round(tail(preco_vitoria_2022,52),2),
...
``` {r}
num <- preco_vitoria_2022[sem_ano]
valueBox(
  value = paste0( "R$", format(round(num,2), decimal.mark =  ",")),
  icon= "fa-pen")
```
...
### Variação Semanal em 2023 e 2024 de Uva Negra Embalada {.no-title}
...
seas23 <- seasplot(preco_vitoriase_2023, trend=F, outplot = F)
medias23 <- colMeans(seas23$season)
...
time <- seq(1:52)
table <- data.frame(time, matrix[,1], round(medias23,2), matrix[,2], round(tail(preco_vitoriase_2022,52),2),
...
``` {r}
num <- preco_vitoriase_2022[sem_ano]
valueBox(
  value = paste0( "R$", format(round(num,2), decimal.mark =  ",")),
  icon= "fa-pen")
```
...
### Mínimo, Máximo, Media e preços de 2021 a 2024 de Uva Negra {.no-title}
...
### Variação Semanal em 2024 e 2023 de Uva Negra {.no-title}
...
``` {r d3}
num <- round(variacao_volume_2022[mes_ano, ],0)
valueBox(
  value = paste0(num, " Toneladas"),
  icon= "fa-pen")
```
...
### Receita de Exportação e Volume Exportado de Uva: 2016 a 2024 {.no-title}
...
g1 <- ggplot(data=dados1) +  #estetica vai valer para todos os geom's
  ...
  labs(y= "US$ Mil / Ton", x= "Anos", title='Receita de Exportação e Volume Exportado de Uva: 2016 a 2024',
       caption = "") +
...
### Principais Destinos da Uva Exportada em Janeiro de 2024 {.no-title}
...
### Principais vias de exportação da uva do Brasil: Janeiro de 2024. {.no-title}
...
### Volume das Exportações de Uva do Brasil: Janeiro de 2024 em comparação com as informações entre 2016-2023 {.no-title}
...
### pela viticultura em `r strftime(atual, format = "%B")` de 2024 
``` {r emp1}
...
### Saldo Gerado pela viticultura em `r strftime(atual, format = "%B")` de 2024
``` {r emp3}
