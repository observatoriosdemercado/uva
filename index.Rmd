...
atual <-  as.Date("2022-10-14")
data <- as.Date("2022-10-21")
...
g1 <- ggplot()+
  ...
  labs(y= "Toneladas", x= "Anos", title='Volume Total comercializado de uva (CEASAS):2017 a 2022',
...
g3 <- ggplot(data=uva_mespeba, aes(x=mes)) +  #estetica vai valer para todos os geom's
  ...
  scale_colour_manual("",
                      ...
                      values = c("blue", "red")) +
  labs(y= "Quantidade (T)", x= "Meses do Ano", title='Tendência do Volume comercializado de uva (CEASAS)',
...
g4 <- ggplot(data=sazonalpeba_graph)+
  ...
  scale_x_date(date_breaks = "1 month",
               labels = date_format("%b"))+
  labs(y= "", x= "Meses de cada Ano", title='Sazonalidade do Volume comercializado de uva (CEASAS)',
...
g5 <- ggplot()+
  ...
  scale_x_date(date_breaks = "1 month",
               labels = date_format("%B"))+
  labs(y= "Toneladas", x= "Meses do Ano", title='Estatísticas sobre a Evolução da Oferta de uva (CEASAS)',
       caption = "")+
  theme_minimal()+
  theme(axis.text.x=element_text(angle=35, hjust=0.5, size=8, margin = margin(b=20)),
        axis.text.y=element_text(hjust=0.5, size=8, margin = margin(l=20)),
...
g2 <- ggplot()+
  ...
  scale_x_date(date_breaks = "1 month",
               labels = date_format("%B"))+
  labs(y= "Variação Percentual (%)", x= "Meses do Ano", title='Variação do Volume comercializado de uva (CEASAS)',
       caption = "Fonte: Observatório de Mercado de uva da Embrapa")+
  theme_minimal()+
  theme(axis.text.x=element_text(angle=35, hjust=0.5, size=8, margin = margin(b=20)),
        axis.text.y=element_text(hjust=0.5, size=8, margin = margin(l=20)),
