...
subclasse_positivos <-dados_08_vsf_positivos%>% filter(subclasse=="132600")
subclasse_negativos <-dados_08_vsf_negativos%>% filter(subclasse=="132600")
