...
output: 
  flexdashboard::flex_dashboard:
    ...
    navbar:
      - {title: "Apoio, Metodologia e Fontes dos Dados", href: "https://observatoriosdemercado.github.io/uva/fonte/", align: right}
    orientation: rows
    #css: styles.css
...
date2 <- seq(as.Date('2024-01-01'),to=as.Date('2024-12-01'),by='1 month')

#Entrando dados no R
dados <- read_excel("uva_ibge2024.xlsx", col_names = TRUE)
...
### Área Plantada com Uva no Brasil em 2024 
``` {r}
num <- 36.5 
valueBox(
...
### Produtividade média da Uva no Brasil em 2024 
``` {r}
num <- 31
valueBox(
...
### Volume com Uva produzida no Brasil em 2024 
``` {r}
num <- 1.13
valueBox(
  value = paste0(format(num, decimal.mark =  ","), " Milhões de Ton." ),
#  color = "lightblue3",
  icon= "fa-pen")
```

### VBP com Uva produzida no Brasil em 2024 
``` {r}
num <- 6.74
valueBox(
...
### Evolução da Area com uva no Brasil: 2011-2024 {.no-title}
...
g1 <- dados %>% 
  ...
  labs(y= "Hectares", x= "Anos", title='Evolução da Area com Uva no Brasil: 2011-2024',
       caption = "Fonte: IBGE (2025)") +
  scale_y_continuous(limits=c(0, 38000), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
...
### Evolução do Volume com uva no Brasil: 2011-2024 {.no-title}
...
g2 <- dados %>% 
  ...
  labs(y= "Mil Toneladas", x= "Anos", title='Evolução do Volume de Uva no Brasil: 2011-2024',
       caption = "Fonte: IBGE (2025)") +
...
### Evolução da Produtividade com uva no Brasil: 2011-2024 {.no-title}
...
g3 <- dados %>% 
  ...
  labs(y= "Produtividade (Ton/Ha)", x= "Anos", title='Evolução da Produtividade da Uva no Brasil: 2011-2024',
       caption = "Fonte: IBGE (2025)") +
  scale_y_continuous(limits=c(0, 32), n.breaks = 5, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2011, 2024, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
### Evolução do Valor Bruto da Produção com uva no Brasil: 2011-2024  {.no-title}
...
g4 <- dados %>% 
  ...
  labs(y= "VBP (Milhões R$)", x= "Anos", title='Evolução do Valor Bruto da Produção da Uva no Brasil: 2011-2024',
       caption = "Fonte: IBGE (2025)") +
  scale_y_continuous(limits=c(0, 6800), n.breaks = 5, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2011, 2024, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
### Área Plantada com Uva no Vale S. Francisco em 2024 
``` {r}
num <- 18.058 
valueBox(
...
### Produtividade média da Uva no Vale S. Francisco em 2024 
``` {r}
num <- 47
valueBox(
  value = paste0( num, " Toneladas/Hectare"),
...
### Volume com Uva produzida no Vale S. Francisco em 2024 
``` {r}
num <- 851
valueBox(
...
### VBP com Uva produzida no Vale S. Francisco em 2024 
``` {r}
num <- 5.2
valueBox(
  value = paste0(format(num, decimal.mark =  ","), " Bilhões de Reais" ),
...
### Evolução da Area com uva no Vale do São Francisco: 2011-2024 {.no-title}

```{r ibge1b}
g1 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=area, fill="Area uva (Hectares)"), lwd=1)+
  scale_fill_manual(values=mycolor1)+
  labs(y= "Hectares", x= "Anos", title='Evolução da Area com Uva no Vale do São Francisco: 2011-2024',
       caption = "Fonte: IBGE (2025)") +
  scale_y_continuous(limits=c(0, 20000), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2011, 2024, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
### Evolução do Volume com uva no Vale do São Francisco: 2011-2024 {.no-title}

```{r ibge2b}
g2 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=quantidade/1000, fill="Volume (Mil Toneladas)"), lwd=1)+
  scale_fill_manual(values=mycolor2)+
  labs(y= "Mil Toneladas", x= "Anos", title='Evolução do Volume de Uva no Vale do São Francisco: 2011-2024',
       caption = "Fonte: IBGE (2025)") +
  scale_y_continuous(limits=c(0, 860), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2011, 2024, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
### Evolução da Produtividade com uva no Vale do São Francisco: 2011-2024 {.no-title}

```{r ibge3b}
g3 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=produtividade, fill="Produtividade (Toneladas/Hectares)"), lwd=1)+
  scale_fill_manual(values=mycolor3)+
  labs(y= "Produtividade (Ton/Ha)", x= "Anos", title='Evolução da Produtividade da Uva no Vale do São Francisco: 2011-2024',
       caption = "IBGE (2025)") +
  scale_y_continuous(limits=c(0, 50), n.breaks = 5, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2011, 2024, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
### Evolução do Valor Bruto da Produção com uva no Vale do São Francisco: 2011-2024  {.no-title}

```{r ibge4b}
g4 <- ggplot(data=dados) +  #estetica vai valer para todos os geom's
  geom_col(aes(x=ano, y=vbp/1000, fill="Valor Bruto Produção (Milhões R$)"), lwd=1)+
  scale_fill_manual(values=mycolor4)+
  labs(y= "VBP (Milhões R$)", x= "Anos", title='Evolução do Valor Bruto da Produção da Uva no Vale do São Francisco: 2011-2024',
       caption = "IBGE (2025)") +
  scale_y_continuous(limits=c(0, 5200), n.breaks = 5, expand = expansion(add=c(0,0.5)))+
  scale_x_continuous(breaks = seq(2011, 2024, by = 1))+
  theme_classic()+ #Definindo tema
  theme(axis.text.x=element_text(angle=0, hjust=0.5, size=12, margin = margin(b=5)),
        axis.text.y=element_text(hjust=1, size=12, margin = margin(l=20)),
...
preco_arra_2025 <- window(preco_arra, end=c(2025,52))
seas25 <- seasplot(preco_arra_2025, trend=F, outplot = F)
...
preco_arra_26 <- as.matrix(tail(arra$preco_def,sem_ano))   
preco_arra_2026 <- matrix(NA, nrow=52, ncol=1)

for(i in 1:sem_ano){
  preco_arra_2026[i,1] = preco_arra_26[i,1]
}
...
time <- seq(1:52)
table <- data.frame(time, matrix[,1], round(medias25,2), matrix[,2], round(tail(preco_arra_2024,52),2),
                    round(tail(preco_arra_2025,52),2), preco_arra_2026[,1])
...
preco_arra_25 <- arra %>% filter(ano=='2025')
preco_arra_2025 <- as.matrix(preco_arra_25$preco_def)
variacao_25 <- (preco_arra_2025/lag(preco_arra_2025, 1) - 1)*100

variacao_26 <- (preco_arra_2026/lag(preco_arra_2026, 1) - 1)*100
...
### Preço de Uva Branca Embalada na Semana `r strftime(data, format = "%V")` de 2026 
``` {r}
...
### Preço de Uva Branca Embalada na Semana `r strftime(data, format = "%V")` de 2025
``` {r}
num <- preco_arra_2025[sem_ano]
valueBox(
  value = paste0( "R$", format(round(num,2), decimal.mark =  ",")),
  icon= "fa-pen")
```

### Preço de Uva Branca Embalada na Semana `r strftime(data, format = "%V")` de 2024
``` {r}
num <- preco_arra_2024[sem_ano]
valueBox(
  value = paste0( "R$", format(round(num,2), decimal.mark =  ",")),
  icon= "fa-pen")
```
...
### Mínimo, Máximo, Media e preços de 2021 a 2025 de Uva Branca Embalada {.no-title}
...
### Variação Semanal em 2026 e 2025 de Uva Branca Embalada {.no-title}
...
### Preço de Uva Negra Embalada na Semana `r strftime(data, format = "%V")` de 2026 

```{r negra_setup}
#Analise das comparações entre as médias
#Analise das comparações entre as médias
preco_vitoria_2025 <- window(preco_vitoria, end=c(2025,52))
seas25 <- seasplot(preco_vitoria_2025, trend=F, outplot = F)
medias25 <- colMeans(seas25$season)
...
preco_vitoria_26 <- as.matrix(tail(vitoria$preco_def,sem_ano))  
preco_vitoria_2026 <- matrix(NA, nrow=52, ncol=1)

for(i in 1:sem_ano){
  preco_vitoria_2026[i,1] = preco_vitoria_26[i,1]
}
...
time <- seq(1:52)
table <- data.frame(time, matrix[,1], round(medias25,2), matrix[,2], round(tail(preco_vitoria_2024,52),2),
                    round(tail(preco_vitoria_2025,52),2), preco_vitoria_2026[,1])
colnames(table) = c('Semanas', 'Mínimo', 'Média', 'Máximo', 'Ano 2024', 'Ano 2025', 
                    'Ano 2026')
tablea <- table[,-c(5:7)]
tableb <- table[,-c(2,3,4)]
...
preco_vitoria_25 <- vitoria %>% filter(ano=='2025')
preco_vitoria_2025 <- as.matrix(preco_vitoria_25$preco_def)
variacao_25 <- (preco_vitoria_2025/lag(preco_vitoria_2025, 1) - 1)*100

variacao_26 <- (preco_vitoria_2026/lag(preco_vitoria_2026, 1) - 1)*100
...
### Preço de Uva Negra Embalada na Semana `r strftime(data, format = "%V")` de 2025
``` {r}
num <- preco_vitoria_2025[sem_ano]
valueBox(
  value = paste0( "R$", format(round(num,2), decimal.mark =  ",")),
  icon= "fa-pen")
```

### Preço de Uva Negra Embalada na Semana `r strftime(data, format = "%V")` de 2024
``` {r}
num <- preco_vitoria_2024[sem_ano]
valueBox(
  value = paste0( "R$", format(round(num,2), decimal.mark =  ",")),
  icon= "fa-pen")
```
...
### Mínimo, Máximo, Media e preços de 2020 a 2026 de Uva Negra Embalada {.no-title}
...
### Variação Semanal em 2025 e 2026 de Uva Negra Embalada {.no-title}
...
#Analise das comparações entre as médias
preco_vitoriase_2025 <- window(preco_vitoriase, end=c(2025,52))
seas25 <- seasplot(preco_vitoriase_2025, trend=F, outplot = F)
medias25 <- colMeans(seas25$season)
...
preco_vitoriase_26 <- as.matrix(tail(vitoriase$preco_def,sem_ano)) #ajustar toda semana
preco_vitoriase_2026 <- matrix(NA, nrow=52, ncol=1)

for(i in 1:sem_ano){
  preco_vitoriase_2026[i,1] = preco_vitoriase_26[i,1]
}
...
time <- seq(1:52)
table <- data.frame(time, matrix[,1], round(medias25,2), matrix[,2], round(tail(preco_vitoriase_2024,52),2),
                    round(tail(preco_vitoriase_2025,52),2), preco_vitoriase_2026[,1])
...
preco_vitoriase_25 <- vitoriase %>% filter(ano=='2025')
preco_vitoriase_2025 <- as.matrix(preco_vitoriase_25$preco_def)
variacao_25 <- (preco_vitoriase_2025/lag(preco_vitoriase_2025, 1) - 1)*100

variacao_26 <- (preco_vitoriase_2026/lag(preco_vitoriase_2026, 1) - 1)*100
...
### Preço de Uva Negra na Semana `r strftime(data, format = "%V")` de 2026 
``` {r}
...
### Preço de Uva Negra na Semana `r strftime(data, format = "%V")` de 2025
``` {r}
num <- preco_vitoriase_2025[sem_ano]
valueBox(
  value = paste0( "R$", format(round(num,2), decimal.mark =  ",")),
  icon= "fa-pen")
```

### Preço de Uva Negra na Semana `r strftime(data, format = "%V")` de 2024
``` {r}
num <- preco_vitoriase_2024[sem_ano]
valueBox(
  value = paste0( "R$", format(round(num,2), decimal.mark =  ",")),
  icon= "fa-pen")
```
...
### Mínimo, Máximo, Media e preços de 2021 a 2026 de Uva Negra {.no-title}
...
### Variação Semanal em 2026 e 2025 de Uva Negra {.no-title}
...
### Volume Exportação em `r strftime(atual, format = "%B")` de 2025 
``` {r d2}
num <- round(variacao_volume_2025[mes_ano, ],0)
valueBox(
  value = paste0(num, " Toneladas"),
  icon= "fa-pen")
```

### Volume Exportação em `r strftime(atual, format = "%B")` de 2024 
``` {r d3}
num <- round(variacao_volume_2024[mes_ano, ],0)
valueBox(
  value = paste0(num, " Toneladas"),
  icon= "fa-pen")
```
...
### Receita de Exportação e Volume Exportado de Uva: 2016 a 2026 {.no-title}
...
g1 <- ggplot(data=dados1) +  #estetica vai valer para todos os geom's
  ...
  labs(y= "US$ Mil / Ton", x= "Anos", title='Receita de Exportação e Volume Exportado de Uva: 2016 a 2026',
       caption = "") +
...
### Principais Destinos da Uva Exportada em Janeiro de 2026 {.no-title}
...
### Principais vias de exportação da uva do Brasil: Janeiro de 2026. {.no-title}
...
### Volume das Exportações de Uva do Brasil: Janeiro de 2026 em comparação com as informações entre 2016-2026 {.no-title}
...
### Importação de Uva pelo Brasil: 2016-2026. {.no-title}
...
saldo_24 <- dados1a |> filter(ano == "2024") |> select(ano, mes, Saldo_uva) |> mutate(mes = as.character(mes))
saldo_25 <- dados1a |> filter(ano == "2025") |> select(ano, mes, Saldo_uva) |> mutate(mes = as.character(mes))
...
saldo_24 <- dados1a |> filter(ano == "2024") |> select(ano, mes, Saldo_uva)
saldo_25 <- dados1a |> filter(ano == "2025") |> select(ano, mes, Saldo_uva)
...
total_24$mes <- factor(total_24$mes,levels = c("Janeiro", "Fevereiro", "Março", "Abril", "Maio", 
...
totalm <- totalm %>%
  rename("Contratados 2024" = Contratados_Uva.x,
         "Demitidos 2024" = Demitidos_Uva.x,
         "Contratados 2025" = Contratados_Uva.y,
         "Demitidos 2025" = Demitidos_Uva.y,
         "Saldo 2024" = Saldo_uva.x,
         "Saldo 2025" = Saldo_uva.y)
...
### pela viticultura em `r strftime(atual, format = "%B")` de 2025 
``` {r emp1}
num <- tail(dados1$Contratados_Uva,1)
valueBox(
...
### pela viticultura em `r strftime(atual, format = "%B")` de 2025 
``` {r emp2}
num <- tail(dados1$Demitidos_Uva,1)
valueBox(
...
### Saldo Gerado pela viticultura em `r strftime(atual, format = "%B")` de 2025
``` {r emp3}
num <- tail(dados1$Saldo_uva,1)
valueBox(
...
g1 <- ggplot() +  #estetica vai valer para todos os geom's
  geom_col(data=saldom, aes(x=mes, y=Saldo_uva, fill=ano), size=2, width = 0.9, position = "dodge")+
    scale_fill_manual(values=mycolors2)+
    labs(y= "Saldo de Emprego (unidade)", x= "Meses do Ano", title='Saldo mensal de Empregos na Viticultura: 2024 e 2025',
       caption = "")+
...
g3 <- ggplot(data=subclasse_positivos, aes(x=idade))+
  ...
  scale_x_continuous(limits=c(17, 70), n.breaks = 10, expand = expansion(add=c(0,0.5)))+
