...
### Variação Semanal em 2025 e 2024 de Uva Branca Embalada {.no-title}
...
``` {r}
num <- preco_vitoria_2023[sem_ano]
valueBox(
  value = paste0( "R$", format(round(num,2), decimal.mark =  ",")),
  icon= "fa-pen")
```
...
### Variação Semanal em 2024 e 2026 de Uva Negra Embalada {.no-title}
...
``` {r}
num <- preco_vitoriase_2023[sem_ano]
valueBox(
  value = paste0( "R$", format(round(num,2), decimal.mark =  ",")),
  icon= "fa-pen")
```
...
### Mínimo, Máximo, Media e preços de 2021 a 2025 de Uva Negra {.no-title}
...
### Volume Exportação em `r strftime(atual, format = "%B")` de 2023 
``` {r d3}
num <- round(variacao_volume_2023[mes_ano, ],0)
valueBox(
  value = paste0(num, " Toneladas"),
  icon= "fa-pen")
```
...
### Receita de Exportação e Volume Exportado de Uva: 2016 a 2025 {.no-title}
...
g1 <- ggplot(data=dados1) +  #estetica vai valer para todos os geom's
  ...
  labs(y= "US$ Mil / Ton", x= "Anos", title='Receita de Exportação e Volume Exportado de Uva: 2016 a 2025',
       caption = "") +
...
### Principais Destinos da Uva Exportada em Dezembro de 2025 {.no-title}
...
### Principais vias de exportação da uva do Brasil: Dezembro de 2025. {.no-title}
...
### Volume das Exportações de Uva do Brasil: Janeiro de 2024 em comparação com as informações entre 2016-2025 {.no-title}
...
### Importação de Uva pelo Brasil: 2016-2025. {.no-title}
