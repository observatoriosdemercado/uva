...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 11,43, variando entre R\$13,00 e R\$ 10,00. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$ 14,90), menor que o valor deflacionado de 2020 (R\$ 15,50), mas maior do que o valor de 2021 (R\$ 10,35). Em relação a semana `r strftime(last, format = "%V")` houve um aumento de 1,24%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $7,65 variando entre R\$ 8,00 e R\$ 7,40. Em 2020, o preço deflacionado é de R\$ 10,75. Em 2021, o preço é de R\$ 6,64 e a média histórica deflacionada para esta semana é de R\$ 11,65. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram (-1,92%). 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` diminuiu em relação a semana anterior (-2,13%), na média de R\$ 4,60, variando entre R\$ 5,50 e R\$ 4,00. Este valor é maior do que o de 2021 deflacionado (R\$ 3,83), mas menor do que o valor de 2020 (R\$ 6,33) e abaixo da média histórica deflacionada da semana (R\$ 7,33).
