...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 11,80, variando entre R\$13,00 e R\$10,00. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$ 13,66), menor que o valor deflacionado de 2020 (R\$ 15,72), mas é maior do que o valor de 2021 (R\$ 10,98). Em relação a semana `r strftime(last, format = "%V")` houve uma redução de -2,48%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $10,17 variando entre R\$ 10,80 e R\$ 9,20. Em 2020, o preço deflacionado é de R\$ 7,94. Em 2021, o preço é de R\$ 8,16 e a média histórica deflacionada para esta semana é de R\$ 11,80. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram (9%). 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` aumentou em relação a semana anterior (5,83%), na média de R\$ 6,35. Este valor é maior do que o de 2021 deflacionado (R\$ 4,56), mais alto do que o valor de 2020 (R\$ 5,14), e maior do que a média histórica deflacionada da semana (R\$ 6,11), algo que nao havia ocorrido ainda em 2022.
