...
O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é de 284 pessoas, ou seja, o total de contratações (2.212) foi maior do que o total de demissões (1.928). Em relação ao mesmo mês do ano passado, se tem uma queda no saldo total (557 em 2021 e 284 em 2022). Nos primeiros seis meses, são 1.488 empregos líquidos a menos do que no mesmo período de 2021. 

Dos contratados, 1.057 são do sexo masculino e 1.155 do sexo feminino. Em relação à idade, a grande maioria se concentra abaixo dos 33 anos: 316 até 21 anos, 295 até 24 anos, 221 até 27 anos, 195 até 30 anos e 186 até 33 anos. 

Em relação ao nivel de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (787 ou 35,58% do total). Este grau de estudo junto com médio incompleto (345), fundamental completo (359) e 6 a 9 ano do fundamental (375), representam a grande parte (84,36%) dos contratados na viticultura no Vale do São Francisco em `r strftime(atual, format = "%B de %Y")`. 
