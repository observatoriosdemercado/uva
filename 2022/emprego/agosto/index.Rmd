...
O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é de 1.057 pessoas, ou seja, o total de contratações (2.636) foi maior do que o total de demissões (1.579). Em relação ao mesmo mês do ano passado, se tem uma queda no saldo total (1.955 em 2021 e 1.057 em 2022). Nos primeiros oito meses, são 2.649 empregos líquidos a menos do que no mesmo período de 2021. 

Dos contratados, 1.066 são do sexo masculino e 1.570 do sexo feminino. Em relação à idade, a maioria se concentra abaixo dos 33 anos: 455 até 21 anos, 380 até 24 anos, 281 até 27 anos, 219 até 30 anos e 207 até 33 anos. 

Sobre o nivel de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (1.059 ou 40,17% do total). Este grau de estudo junto com médio incompleto (465), fundamental completo (352) e 6 a 9 ano do fundamental (415), representam a grande parte (86,48%) dos contratados na viticultura no Vale do São Francisco em `r strftime(atual, format = "%B de %Y")`. 
