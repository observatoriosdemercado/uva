...
O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é de -1.186 pessoas, ou seja, o total de contratações (1.644) foi menor do que o total de demissões (2.830). Em relação ao mesmo mês do ano passado, se tem uma melhoria no saldo total (-2.557 em 2021 e -1.186 em 2022), pois o número de pessoas que perderam o emprego foi menor. Nos onze meses, são 1.221 empregos líquidos a menos do que no mesmo período de 2021. 

Dos contratados, 949 são do sexo feminino e 693 do sexo masculino. Em relação à idade, 44,3% se concentra abaixo dos 27 anos: 238 até 21 anos, 289 até 24 anos e 202 até 27 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (453 ou 27,55% do total). Este grau de estudo junto com fundamental completo (423) e 6 a 9 ano do fundamental (320), representam a grande parte (72,75%) dos contratados na viticultura no Vale do São Francisco em `r strftime(atual, format = "%B de %Y")`. 
