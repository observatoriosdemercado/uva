...
O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é de -1.578 pessoas, ou seja, o total de contratações (1.425) foi menor do que o total de demissões (3.003). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (-1.019 em 2021 e -1.578 em 2022), pois o número de pessoas que perderam o emprego foi maior. Nos ano, são 1.780 empregos líquidos a menos do que no mesmo período de 2021. 

Dos contratados, 801 são do sexo feminino e 623 do sexo masculino. Em relação à idade, 49,5% se concentra abaixo dos 30 anos: 225 até 21 anos, 201 até 24 anos, 160 até 27 anos e 119 até 30 anos. 

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (444 ou 31,16% do total). Este grau de estudo junto com fundamental completo (298) e 6 a 9 ano do fundamental (269), representam a grande parte (70,95%) dos contratados na viticultura no Vale do São Francisco em `r strftime(atual, format = "%B de %Y")`. 
