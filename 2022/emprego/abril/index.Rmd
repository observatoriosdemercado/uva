...
Em relação ao nivel de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (472 ou 40% do total). Este grau de estudo junto com médio incompleto (350) representa a grande parte (56,65%) dos contratados na viticultura no Vale do São Francisco em `r strftime(atual, format = "%B de %Y")`. 
