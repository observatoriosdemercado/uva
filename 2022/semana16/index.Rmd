...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 9,15, variando entre R\$11,00 e R\$ 7,00. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$ 11,75), menor que o valor deflacionado de 2020 (R\$ 10,62), mas é mais alto que o valor de 2021 (R\$ 8,46). Em relação a semana `r strftime(last, format = "%V")` houve aumento, de 2,46%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $8,34, variando entre R\$ 10,63 e R\$ 7,60. Em 2020, o preço deflacionado é de R\$ 11,36. Em 2021 o preço é de R\$ 7,50 e a média histórica deflacionada para esta semana é de R\$ 13,71. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram (-3,70%). 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` reduziu novamente em relação a semana anterior (-8,43%), na média de R\$ 4,67, variando entre R\$ 5,50 e R\$ 4,00. Este valor é maior do que o de 2021 deflacionado (R\$ 4,12), mas é menor do que o valor de 2020 (R\$ 6,41) e menor do que a média histórica deflacionada da semana (R\$ 6,29).
