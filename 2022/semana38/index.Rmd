...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 10,85, variando entre R\$11,60 e R\$10,00. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$12,22), menor que o valor deflacionado de 2020 (R\$14,96), mas é maior do que o valor de 2021 (R\$8,57). Em relação a semana `r strftime(last, format = "%V")` houve uma redução de -2,52%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $11,13 variando entre R\$ 11,60 e R\$ 10,80. Em 2020, o preço deflacionado é de R\$ 10,82. Em 2021, o preço é de R\$ 7,82 e a média histórica deflacionada para esta semana é de R\$ 11,07. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram (-0,62%). 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` caiu em relação a semana anterior (-5,52%), na média de R\$6,50. Este valor é maior do que o de 2021 deflacionado (R\$ 3,91), mais alto do que o valor de 2020 (R\$ 6,51), e maior do que a média histórica deflacionada da semana (R\$ 6,25).
