...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 9,61, variando entre R\$11,25 e R\$ 8,00. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$ 11,92), menor que o valor deflacionado de 2020 (R\$ 13,78), mas é mais alto que o valor de 2021 (R\$ 7,84). Em relação a semana `r strftime(last, format = "%V")` houve uma diminuição de de -3,32%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $5,90, variando entre R\$ 7,20 e R\$ 5,20. Em 2020, o preço deflacionado é de R\$ 11,84. Em 2021 o preço é de R\$ 6,15 e a média histórica deflacionada para esta semana é de R\$ 12,43. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram (-4,68%). É a nona semana seguida de queda de preços de vitória embalada.

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` aumentou em relação a semana anterior (8,17%), na média de R\$ 2,78, variando entre R\$ 3,50 e R\$ 2,50. Este valor é maior do que o de 2021 deflacionado (R\$ 2,42), menor do que o valor de 2020 (R\$ 7,12) e abaixo da média histórica deflacionada da semana (R\$ 6,16).
