...
library(lubridate)
last <- as.Date("2022-12-02")
today <- as.Date("2022-12-09")
...
Os dados utilizados nesta análise são semanais e disponibilizados pelo **CEPEA (Esalq-USP)** englobando o período de 2017 a 2022, de uva sem semente branca e negra embaladas (incluso uva+material de embalagem+resfriamento, FOB-Petrolina), para os produtores do Vale do São Francisco. Também mostra informações sobre a uva negra sem embalagem, com dados semanais de 2019 à 2022. Os preços até a semana `r strftime(today, format = "%V de %Y")`, deflacionados pelo IGP-DI, são comparados com a média de cada semana entre 2017 e 2019 (pré pandemia), mínimo e máximo. Os preços deflacionados de 2020 e de 2021 também são apresentados para comparação de 2022 com os dois anos anteriores.

O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 11,20, variando entre R\$12,00 e R\$10,00. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$13,45), menor que o valor deflacionado de 2020 (R\$12,53), e que o valor de 2021 (R\$11,56). Em relação a semana `r strftime(last, format = "%V")` houve um aumento de 1,82%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $8,90 variando entre R\$ 9,60 e R\$ 7,60. Em 2020, o preço deflacionado é de R\$ 9,32. Em 2021, o preço é de R\$ 8,10 e a média histórica deflacionada para esta semana é de R\$ 11,58. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 7,88%. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` ficou estável em relação a semana anterior, mantendo a média de R\$3,25, variando entre R\$3,50 e R\$3,00. Este valor é menor do que o de 2021 deflacionado (R\$ 4,77), mais baixo do que o valor de 2020 (R\$ 6,04), e que a média histórica deflacionada da semana (R\$ 6,51).
