...
O preço médio de Palmer na semana `r strftime(today, format = "%V de %Y")` foi R\$0,73, variando entre R\$0,90 e R\$0,60. A média histórica dos dados deflacionados, desde 2012 até 2019 (pré pandemia), para esta semana, é R\$1,96. Em 2020, o preço deflacionado é de R\$0,73 para a semana `r strftime(today, format = "%V")` e, em 2021, o preço é R\$ 2,58. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 4,29%.

No caso da Tommy, na semana `r strftime(today, format = "%V de %Y")` os preços médios foram de R\$0,39, variando entre R\$0,50 e R\$0,30. Este valor é mais baixo do que a média histórica para esta semana, R\$ 1,05, menor que o preço deflacionado de 2020 (R\$0,57) e que o preço de 2021 (R\$1,31). Em relação à semana anterior os preços aumentaram 11,43%.
