...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 11,00, variando entre R\$12,00 e R\$10,00. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$11,61), menor que o valor deflacionado de 2020 (R\$14,52), mas é maior do que o valor de 2021 (R\$8,99). Em relação a semana `r strftime(last, format = "%V")` houve um aumento de 7,32%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $8,70 variando entre R\$ 9,00 e R\$ 8,40. Em 2020, o preço deflacionado é de R\$ 10,78. Em 2021, o preço é de R\$ 7,78 e a média histórica deflacionada para esta semana é de R\$ 11,46. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram (-5,95%). 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` diminuiu em relação a semana anterior (-4,17%), na média de R\$4,82, variando entre R\$5,50 e R\$4,30. Este valor é maior do que o de 2021 deflacionado (R\$ 3,94), mas é mais baixo do que o valor de 2020 (R\$ 6,85), e que a média histórica deflacionada da semana (R\$ 6,50).
