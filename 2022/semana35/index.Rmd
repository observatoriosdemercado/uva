...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 11,65, variando entre R\$13,00 e R\$11,00. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$ 13,63), menor que o valor deflacionado de 2020 (R\$ 15,73), mas é maior do que o valor de 2021 (R\$ 10,37). Em relação a semana `r strftime(last, format = "%V")` houve uma queda de -2,10%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $11,87 variando entre R\$ 13,00 e R\$ 11,00. Em 2020, o preço deflacionado é de R\$ 8,48. Em 2021, o preço é de R\$ 7,89 e a média histórica deflacionada para esta semana é de R\$ 10,16. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram (5,51%). 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` aumentou um pouco em relação a semana anterior (0,27%), na média de R\$ 7,35. Este valor é maior do que o de 2021 deflacionado (R\$ 4,81), mais alto do que o valor de 2020 (R\$ 5,11), e maior do que a média histórica deflacionada da semana (R\$ 5,59).
