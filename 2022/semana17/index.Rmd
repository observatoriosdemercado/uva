...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 8,20, variando entre R\$9,00 e R\$ 6,80. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$ 11,08), menor que o valor deflacionado de 2020 (R\$ 11,08), mas é mais alto que o valor de 2021 (R\$ 7,61). Em relação a semana `r strftime(last, format = "%V")` houve redução, de -10,38%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $7,20, variando entre R\$ 8,00 e R\$ 6,00. Em 2020, o preço deflacionado é de R\$ 10,38. Em 2021 o preço é de R\$ 6,99 e a média histórica deflacionada para esta semana é de R\$ 13,64. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram fortemente (-13,67%). 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` reduziu novamente em relação a semana anterior (-19,49%), na média de R\$ 3,76, variando entre R\$ 4,50 e R\$ 3,00. Este valor é menor do que o de 2021 deflacionado (R\$ 3,79), menor do que o valor de 2020 (R\$ 6,41) e abaixo da média histórica deflacionada da semana (R\$ 6,23).
