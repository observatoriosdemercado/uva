...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 11,00, variando entre R\$13,00 e R\$9,40. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$ 12,58), menor que o valor deflacionado de 2020 (R\$ 15,21), mas é maior do que o valor de 2021 (R\$ 10,30). Em relação a semana `r strftime(last, format = "%V")` houve uma queda de -5,58%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $12,25 variando entre R\$ 13,00 e R\$ 12,00. Em 2020, o preço deflacionado é de R\$ 9,14. Em 2021, o preço é de R\$ 7,82 e a média histórica deflacionada para esta semana é de R\$ 10,35. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram (3,20%). 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` aumentou um pouco em relação a semana anterior (1,09%), na média de R\$ 7,43. Este valor é maior do que o de 2021 deflacionado (R\$ 4,37), mais alto do que o valor de 2020 (R\$ 5,35), e maior do que a média histórica deflacionada da semana (R\$ 5,65).
