...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 11,67, variando entre R\$12,00 e R\$11,00. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$13,64), menor que o valor deflacionado de 2020 (R\$12,64), e que o valor de 2021 (R\$12,92). Em relação a semana `r strftime(last, format = "%V")` houve um aumento de 4,2%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $8,87 variando entre R\$ 9,60 e R\$ 8,00. Em 2020, o preço deflacionado é de R\$ 9,92. Em 2021, o preço é de R\$ 9,56 e a média histórica deflacionada para esta semana é de R\$ 12,12. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -0,34%. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` aumentou em relação a semana anterior (17,85%), na média de R\$3,83, variando entre R\$4,00 e R\$3,50. Este valor é menor do que o de 2021 deflacionado (R\$ 5,18), mais baixo do que o valor de 2020 (R\$ 6,23), e que a média histórica deflacionada da semana (R\$ 6,86).
