...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 9,69, variando entre R\$11,60 e R\$ 7,60. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$ 11,32), menor que o valor deflacionado de 2020 (R\$ 11,12), mas é mais alto que o valor de 2021 (R\$ 7,42). Em relação a semana `r strftime(last, format = "%V")` houve aumento de 18,17%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $6,77, variando entre R\$ 7,60 e R\$ 5,60. Em 2020, o preço deflacionado é de R\$ 10,29. Em 2021 o preço é de R\$ 6,71 e a média histórica deflacionada para esta semana é de R\$ 12,90. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram fortemente (-5,97%). 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` reduziu novamente em relação a semana anterior (-14,10%), na média de R\$ 3,23, variando entre R\$ 4,00 e R\$ 2,30. Este valor é menor do que o de 2021 deflacionado (R\$ 3,50), menor do que o valor de 2020 (R\$ 5,91) e abaixo da média histórica deflacionada da semana (R\$ 6,00).
