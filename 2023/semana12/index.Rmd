...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 14,67, variando entre R\$15,60 e R\$14,00. Este valor é maior do que a média histórica deflacionado encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 12,50, maior do que o preço de 2021 (R\$9,91) e que o de 2022 (R\$12,00). Em relação a semana `r strftime(last, format = "%V")`, houve uma queda de -1,54%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 9,25 variando entre R\$ 10,00 e R\$ 9,00. Em 2021, o preço deflacionado é de R\$ 8,45. Em 2022, o preço é de R\$ 11,25 e a média histórica deflacionada para esta semana é de R\$ 15,11. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -16,44%. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` reduziu em relação a semana anterior (-24,97%), na média de R\$5,50. Este valor é maior do que o de 2021 deflacionado (R\$ 5,48), mas é menor do que a média histórica deflacionada da semana (R\$ 8,07) e que a média de 2022 (R\$7,14).
