...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 10,62, variando entre R\$11,50 e R\$10,00. Este valor é menor do que a média histórica deflacionado encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 13,93, mas é maior do que o preço de 2021 (R\$9,58), e igual ao de 2022 (R\$10,62). Em relação a semana `r strftime(last, format = "%V")`, houve uma redução de -0,28%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 9,64 variando entre R\$ 10,60 e R\$ 8,60. Em 2021, o preço deflacionado é de R\$ 6,14. Em 2022, o preço é de R\$ 7,11 e a média histórica deflacionada para esta semana é de R\$ 10,57. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 3,66%. 

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` aumentou 6,33% em relação a semana anterior, R\$6,38, variando entre R\$7,00 e R\$6,00. Este valor é menor do que a média histórica deflacionada da semana (R\$6,79), mas é maior do que o preço de 2021 deflacionado (R\$ 3,55), e que a média de 2022 (R\$4,27).
