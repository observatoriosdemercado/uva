...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 10,65, variando entre R\$11,00 e R\$10,00. Este valor é menor do que a média histórica deflacionado encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 13,71, mas é maior do que o preço de 2021 (R\$10,12), e que o de 2022 (R\$10,49). Em relação a semana `r strftime(last, format = "%V")`, houve uma redução de -4,48%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 9,30 variando entre R\$ 10,60 e R\$ 8,00. Em 2021, o preço deflacionado é de R\$ 6,13. Em 2022, o preço é de R\$ 7,25 e a média histórica deflacionada para esta semana é de R\$ 10,72. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -6,25%. 

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` aumentou 1,69% em relação a semana anterior, R\$6,00, variando entre R\$6,50 e R\$5,50. Este valor é menor do que a média histórica deflacionada da semana (R\$6,59), mas é maior do que o preço de 2021 deflacionado (R\$ 3,66), e que a média de 2022 (R\$4,37).
