...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 11,00, variando entre R\$12,00 e R\$10,40. Este valor é maior do que a média histórica deflacionado encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 10,98, maior do que o preço de 2021 (R\$7,09) e que o de 2022 (R\$9,51). Em relação a semana `r strftime(last, format = "%V")`, houve uma redução de -2,91%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 6,70 variando entre R\$ 7,20 e R\$ 6,40. Em 2021, o preço deflacionado é de R\$ 5,96. Em 2022, o preço é de R\$ 6,01 e a média histórica deflacionada para esta semana é de R\$ 11,71. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -3,32%. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` reduziu em relação a semana anterior (-2,09%), na média de R\$3,75. Este valor é menor do que a média histórica deflacionada da semana (R\$5,36), do que o preço de 2021 deflacionado (R\$ 4,44), mas é maior do que a média de 2022 (R\$2,71).
