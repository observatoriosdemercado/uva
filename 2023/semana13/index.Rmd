...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 14,70, variando entre R\$15,00 e R\$14,00. Este valor é maior do que a média histórica deflacionado encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 11,95, maior do que o preço de 2021 (R\$10,40) e que o de 2022 (R\$10,96). Em relação a semana `r strftime(last, format = "%V")`, houve um aumento de 0,20%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 8,02 variando entre R\$ 9,00 e R\$ 7,10. Em 2021, o preço deflacionado é de R\$ 8,34. Em 2022, o preço é de R\$ 10,58 e a média histórica deflacionada para esta semana é de R\$ 14,56. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -13,30%. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` reduziu em relação a semana anterior (-27,27%), na média de R\$4,00. Este valor é menor do que o de 2021 deflacionado (R\$ 4,68), que a média de 2022 (R\$6,60) e menor do que a média histórica deflacionada da semana (R\$ 7,48).
