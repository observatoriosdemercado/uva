...
sem_ano <- 2 #ajustar semanalmente
```
...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 11,00, variando entre R\$11,60 e R\$10,40. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$13,98), menor que o valor deflacionado de 2021 (R\$11,37), e que o valor de 2022 (R\$12,25). Em relação a semana `r strftime(last, format = "%V")` houve uma redução de -5,5%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $9,00 variando entre R\$ 10,00 e R\$ 8,00. Em 2021, o preço deflacionado é de R\$ 8,24. Em 2022, o preço é de R\$ 9,40 e a média histórica deflacionada para esta semana é de R\$ 13,40. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 12,50%. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` diminuiu em relação a semana anterior (-4,65%), na média de R\$5,13, variando entre R\$5,50 e R\$5,00. Este valor é maior do que o de 2021 deflacionado (R\$ 4,81), mas é inferior ao valor de 2022 (R\$ 5,97) e que a média histórica deflacionada da semana (R\$ 8,60).
