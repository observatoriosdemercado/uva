...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 11,15, variando entre R\$12,00 e R\$10,00. Este valor é menor do que a média histórica deflacionado encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 13,28, mas é maior do que o preço de 2021 (R\$10,17), e que o de 2022 (R\$10,41). Em relação a semana `r strftime(last, format = "%V")`, houve um aumento de 1,55%, o quinto consecutivo.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 9,92 variando entre R\$ 11,00 e R\$ 9,00. Em 2021, o preço deflacionado é de R\$ 6,37. Em 2022, o preço é de R\$ 7,32 e a média histórica deflacionada para esta semana é de R\$ 10,683. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -4,25%. 

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` aumentou 4,80% em relação a semana anterior, R\$5,90, variando entre R\$6,50 e R\$5,50. Este valor é menor do que a média histórica deflacionada da semana (R\$6,83), mas é maior do que o preço de 2021 deflacionado (R\$ 3,37), e que a média de 2022 (R\$4,41).
