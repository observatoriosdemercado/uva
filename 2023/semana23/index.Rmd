...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 8,13, variando entre R\$9,00 e R\$6,80. Este valor é menor do que a média histórica deflacionado encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 11,48, menor do que o preço de 2022 (R\$9,51) e do que o de 2021 (R\$8,67). Em relação a semana `r strftime(last, format = "%V")`, houve uma redução de -2,28%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 8,52 variando entre R\$ 9,20 e R\$ 7,00. Em 2021, o preço deflacionado é de R\$ 6,06. Em 2022, o preço é de R\$ 5,18 e a média histórica deflacionada para esta semana é de R\$ 11,15. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 6,77%. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` aumentou em relação a semana anterior (9,15%), na média de R\$5,13. Este valor é menor do que a média histórica deflacionada da semana (R\$6,83), mas é maior do que o preço de 2021 deflacionado (R\$ 2,67), e que a média de 2022 (R\$3,08).
