...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 12,42, variando entre R\$13,00 e R\$11,50. Este valor é maior do que a média histórica deflacionado encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 12,33, mais alto do que o preço de 2022 (R\$10,97) e que o preço de 2021 (R\$9,59). Em relação a semana `r strftime(last, format = "%V")`, houve estabilidade dos preços.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 9,60 variando entre R\$ 10,00 e R\$ 8,80. Em 2021, o preço deflacionado é de R\$ 7,28. Em 2022, o preço é de R\$ 11,54 e a média histórica deflacionada para esta semana é de R\$ 9,35. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -1,03%. 

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` é R\$5,00, variando entre R\$6,00 e R\$4,50. Isto significa uma queda de -11,19% em relação a semana anterior. Este valor é menor do que a média histórica deflacionada da semana (R\$5,26), menor do que a média de 2022 (R\$7,00), mas é mais alto do que o preço de 2021 deflacionado (R\$ 4,07).
