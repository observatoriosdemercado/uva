...
Os dados utilizados nesta análise são semanais e disponibilizados pelo **CEPEA (Esalq-USP)** englobando o período de 2017 a 2023, de uva sem semente branca e negra embaladas (incluso uva+material de embalagem+resfriamento, FOB-Petrolina), para os produtores do Vale do São Francisco. Também mostra informações sobre a uva negra sem embalagem, com dados semanais de 2019 à 2023. Os preços até a semana `r strftime(today, format = "%V de %Y")`, deflacionados pelo IGP-DI, são comparados com a média de cada semana entre 2017 e 2020, mínimo e máximo. Os preços deflacionados de 2021 e de 2022 também são apresentados para comparação de 2023 com os dois anos anteriores.

O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 12,50, variando entre R\$13,00 e R\$12,00. Este valor é menor do que a média histórica deflacionado encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 13,64, mas é maior do que o preço de 2022 (R\$11,26) e que o preço de 2021 (R\$10,10). Em relação a semana `r strftime(last, format = "%V")`, houve um aumento de 20,42%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 9,84 variando entre R\$ 10,60 e R\$ 9,00. Em 2021, o preço deflacionado é de R\$ 7,47. Em 2022, o preço é de R\$ 8,68 e a média histórica deflacionada para esta semana é de R\$ 9,83. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 0,41%. 

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` ficou estável em relação a semana anterior, R\$6,25, variando entre R\$6,50 e R\$6,00. Este valor é maior do que a média histórica deflacionada da semana (R\$5,76), mais alto do que o preço de 2021 deflacionado (R\$ 4,13) e que a média de 2022 (R\$5,58).
...
## EVOLUÇÃO DA TENDÊNCIA DE UVA BRANCA SEM SEMENTE EMBALADA NO VALE SÃO FRANCISCO: 2017 A 2023
...
## EVOLUÇÃO DA TENDÊNCIA DE UVA NEGRA SEM SEMENTE EMBALADA NO VALE SÃO FRANCISCO: 2017 A 2023.
...
## EVOLUÇÃO DA TENDÊNCIA DE UVA NEGRA SEM SEMENTE NO VALE SÃO FRANCISCO: 2019 A 2023.
...
<center> [Dashboard Mercado de Uva - https://bit.ly/3OgmyKp](https://bit.ly/3OgmyKp) </center>
