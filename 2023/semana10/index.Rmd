...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 15,40, variando entre R\$16,40 e R\$15,00. Esta média é maior do que o máximo histórico deflacionado encontrado na semana `r strftime(today, format = "%V")`, que é R\$ 13,44. Em relação a semana `r strftime(last, format = "%V")` houve um aumento de 5,48%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 12,15 variando entre R\$ 13,00 e R\$ 11,00. Em 2021, o preço deflacionado é de R\$ 9,81. Em 2022, o preço é de R\$ 11,56 e a média histórica deflacionada para esta semana é de R\$ 14,75. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -5,45%. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` reduziu em relação a semana anterior (4,63%), na média de R\$7,63. Este valor é maior do que o de 2021 deflacionado (R\$ 5,65), mas é menor do que a média histórica deflacionada da semana (R\$ 8,14) e que a média de 2022 (R\$7,90).
