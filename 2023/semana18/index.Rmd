...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 11,33, variando entre R\$12,00 e R\$11,00. Este valor é maior do que a média histórica deflacionado encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 11,23, maior do que o preço de 2021 (R\$7,39) e que o de 2022 (R\$9,58). Em relação a semana `r strftime(last, format = "%V")`, houve uma redução de -18,61%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 6,93 variando entre R\$ 8,00 e R\$ 6,00. Em 2021, o preço deflacionado é de R\$ 6,68. Em 2022, o preço é de R\$ 6,70 e a média histórica deflacionada para esta semana é de R\$ 12,20. Em relação à semana `r strftime(last, format = "%V")`, os preços diminuíram -12,28%. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` reduziu em relação a semana anterior (-1,29%), na média de R\$3,83. Este valor é maior do que o de 2021 deflacionado (R\$ 3,49), maior do que a média de 2022 (R\$3,19), mas é menor do que a média histórica deflacionada da semana (R\$5,97).
