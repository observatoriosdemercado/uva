...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 12,60, variando entre R\$13,20 e R\$12,00. Este valor é menor do que a média histórica deflacionado encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 13,11, mas é maior do que o preço de 2022 (R\$10,98) e que o preço de 2021 (R\$10,16). Em relação a semana `r strftime(last, format = "%V")`, houve um aumento de 0,80%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 9,60 variando entre R\$ 10,00 e R\$ 8,80. Em 2021, o preço deflacionado é de R\$ 7,55. Em 2022, o preço é de R\$ 9,46 e a média histórica deflacionada para esta semana é de R\$ 9,33. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -2,44%. 

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` diminuiu 8,80% em relação a semana anterior, R\$5,70, variando entre R\$6,50 e R\$5,00. Este valor é maior do que a média histórica deflacionada da semana (R\$5,65), mais alto do que o preço de 2021 deflacionado (R\$ 4,22), mas é menor do que a média de 2022 (R\$5,91).
