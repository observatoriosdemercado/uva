...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 13,28, variando entre R\$14,00 e R\$12,00. Este valor é maior do que a média histórica deflacionado encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 12,019, mais alto do que o preço de 2022 (R\$10,22) e que o preço de 2021 (R\$7,97). Em relação a semana `r strftime(last, format = "%V")`, houve aumento de 5,48% nos preços.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 8,70 variando entre R\$ 10,00 e R\$ 8,00. Em 2021, o preço deflacionado é de R\$ 7,28. Em 2022, o preço é de R\$ 10,49 e a média histórica deflacionada para esta semana é de R\$ 10,25. Em relação à semana `r strftime(last, format = "%V")`, os preços reduziram -6,45%. 

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` é R\$4,18, variando entre R\$4,50 e R\$4,00. Isto significa uma queda de -14,60% em relação a semana anterior. Este valor é menor do que a média histórica deflacionada da semana (R\$5,82), menor do que a média de 2022 (R\$ 6,13), mas é mais alto do que o preço de 2021 deflacionado (R\$ 3,64).
