...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 14,00, variando entre R\$15,00 e R\$12,50. Este valor é maior do que a média histórica deflacionada encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 12,15, mais alto do que o preço de 2022 (R\$9,29) e que o preço de 2021 (R\$7,41). Em relação a semana `r strftime(last, format = "%V")`, houve aumento de 0,72% nos preços.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 10,13 variando entre R\$ 10,80 e R\$ 9,60. Em 2021, o preço deflacionado é de R\$ 7,68. Em 2022, o preço é de R\$ 8,26 e a média histórica deflacionada para esta semana é de R\$ 9,64. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 9,16%. 

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` é R\$5,00, variando entre R\$5,50 e R\$4,50. Isto significa um aumento de 4,60% em relação a semana anterior. Este valor é menor do que a média histórica deflacionada da semana (R\$5,61), mas é maior do que a média de 2022 (R\$ 4,66) e mais alto do que o preço de 2021 deflacionado (R\$ 3,54).
