...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 9,55, variando entre R\$10,00 e R\$9,00. Este valor é menor do que a média histórica deflacionado encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 11,98, menor do que o preço de 2021 (R\$10,02), mas é maior do que o de 2022 (R\$9,11). Em relação a semana `r strftime(last, format = "%V")`, houve um aumento de 17,44%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 9,50 variando entre R\$ 10,00 e R\$ 9,00. Em 2021, o preço deflacionado é de R\$ 7,23. Em 2022, o preço é de R\$ 6,10 e a média histórica deflacionada para esta semana é de R\$ 11,06. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 11,50%. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` diminuiu em relação a semana anterior (-2,53%), na média de R\$5,00, variando entre R\$5,50 e R\$4,50. Este valor é menor do que a média histórica deflacionada da semana (R\$6,83), mas é maior do que o preço de 2021 deflacionado (R\$ 2,74), e que a média de 2022 (R\$3,01).
