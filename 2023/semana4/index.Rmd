...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 11,05, variando entre R\$11,60 e R\$10,60. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$13,80), menor que o valor deflacionado de 2021 (R\$12,57), e que o valor de 2022 (R\$13,22). Em relação a semana `r strftime(last, format = "%V")` houve uma redução de -0,45%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $10,60 variando entre R\$ 11,00 e R\$ 10,00. Em 2021, o preço deflacionado é de R\$ 9,77. Em 2022, o preço é de R\$ 10,60 e a média histórica deflacionada para esta semana é de R\$ 13,35. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 8,72%. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` aumentou em relação a semana anterior (15,45%), na média de R\$6,50. Este valor é maior do que o de 2021 deflacionado (R\$ 6,34), que o valor de 2022 (R\$ 6,37), mas é menor que a média histórica deflacionada da semana (R\$ 9,22).
