...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 12,52, variando entre R\$13,20 e R\$12,00. A média nesta semana é menor do que a média histórica semanal deflacionada (R\$13,77), menor que o valor deflacionado de 2021 (R\$12,98), e que o valor de 2022 (R\$14,47). Em relação a semana `r strftime(last, format = "%V")` houve um crescimento de 10,50%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $12,55 variando entre R\$ 13,00 e R\$ 12,00. Em 2021, o preço deflacionado é de R\$ 11,66. Em 2022, o preço é de R\$ 11,58 e a média histórica deflacionada para esta semana é de R\$ 13,21. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 17,62%. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` aumentou em relação a semana anterior (2,89%), na média de R\$7,82. Este valor é maior do que o de 2021 deflacionado (R\$ 6,30), que o valor de 2022 (R\$ 7,10), mas é menor que a média histórica deflacionada da semana (R\$ 8,41).
