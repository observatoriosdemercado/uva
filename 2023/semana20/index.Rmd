...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 10,00, variando entre R\$11,20 e R\$9,20. Este valor é menor do que a média histórica deflacionado encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 11,57, mas é maior do que o preço de 2021 (R\$7,32) e que o de 2022 (R\$9,62). Em relação a semana `r strftime(last, format = "%V")`, houve uma redução de -9,09%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 6,70 variando entre R\$ 7,20 e R\$ 6,40. Em 2021, o preço deflacionado é de R\$ 6,35. Em 2022, o preço é de R\$ 5,99 e a média histórica deflacionada para esta semana é de R\$ 12,25. Em relação à semana `r strftime(last, format = "%V")`, os preços ficaram estáveis. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` reduziu em relação a semana anterior (-3,20%), na média de R\$3,63. Este valor é menor do que a média histórica deflacionada da semana (R\$5,99), mas é maior do que o preço de 2021 deflacionado (R\$ 3,21), e que a média de 2022 (R\$2,49).
