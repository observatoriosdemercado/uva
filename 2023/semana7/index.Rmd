...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 13,45, variando entre R\$14,00 e R\$13,00. A média nesta semana é pouco menor do que a média histórica semanal deflacionada (R\$13,54), menor que o valor deflacionado de 2022 (R\$13,79), mas é maior que o valor de 2021 (R\$13,24). Em relação a semana `r strftime(last, format = "%V")` houve um crescimento de 7,43%.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\ $13,05 variando entre R\$ 13,40 e R\$ 12,80. Em 2021, o preço deflacionado é de R\$ 12,05. Em 2022, o preço é de R\$ 12,26 e a média histórica deflacionada para esta semana é de R\$ 13,93. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 3,98%. 

Para a uva sem semente negra, o preço na semana `r strftime(today, format = "%V")` diminuiu em relação a semana anterior (-0,9%), na média de R\$7,75. Este valor é maior do que o de 2021 deflacionado (R\$ 6,26), que o valor de 2022 (R\$ 7,26), mas é menor que a média histórica deflacionada da semana (R\$ 8,44).
