...
O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é de -272 pessoas, ou seja, o total de contratações (2.081) foi menor do que o total de demissões (2.353). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (-574 em 2022 e -272 em 2023), pois o número de pessoas que perderam o emprego foi menor. 

Dos contratados no mês, 1.055 são do sexo masculino e 1.026 do sexo feminino. Em relação à idade, 15,52% dos contratados tem até 21 anos, 14,42% até 24 anos, 11,29% até 27 anos e 7,78% até 30 anos.

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (814). Do total de contratados, 39,12% possuem este nível de escolaridade.

Com relação aos salários pagos, 77,46% dos contratados foram pelo valor de R\$ 1.302,00, o salário mínimo nacional. O salário mais elevado foi R\$ 7.295,00.
