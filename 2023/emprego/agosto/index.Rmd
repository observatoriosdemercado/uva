...
O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é de 1.583 pessoas, ou seja, o total de contratações (3.726) foi maior do que o total de demissões (2.143). Em relação ao mesmo mês do ano passado, se tem uma grande melhora no saldo total (1.057 em 2022 e 1.583 em 2023), pois o número de pessoas que conseguiram o emprego foi 49,8% maior. 

Dos contratados no mês, 2.305 são do sexo feminino (62% do total) e 1.421 do sexo masculino. Em relação à idade, 17,10% dos contratados tem até 21 anos, 13,79% até 24 anos, 12,13% até 27 anos e 7,70% até 30 anos.

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (1.470). Do total de contratados, 39,45% possuem este nível de escolaridade.

Com relação aos salários pagos, 91,33% dos contratados foram pelo valor de R\$ 1.354,00, acima do salário mínimo nacional, conforme acordo pela CCT 2023. O salário mais elevado foi R\$ 13.543,00.
...
g5 <- ggplot(data=subclasse_positivos, aes(x=salario))+
  ...
  scale_x_continuous(limits=c(0, 7500), n.breaks = 6, expand = expansion(add=c(0,0.5)))+
