...
O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é de 539 pessoas, ou seja, o total de contratações (2.535) foi menor do que o total de demissões (1.996). Em relação ao mesmo mês do ano passado, se tem uma melhora no saldo total (303 em 2022 e 539 em 2023), pois o número de pessoas que conseguiram o emprego foi maior. 

Dos contratados no mês, 1.318 são do sexo masculino e 1.217 do sexo feminino. Em relação à idade, 15,07% dos contratados tem até 21 anos, 14,36% até 24 anos, 10,22% até 27 anos e 8,17% até 30 anos.

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (944). Do total de contratados, 37,24% possuem este nível de escolaridade.

Com relação aos salários pagos, 76,90% dos contratados foram pelo valor de R\$ 1.320,00, o salário mínimo nacional no mês. O salário mais elevado foi R\$ 13.900,00.
