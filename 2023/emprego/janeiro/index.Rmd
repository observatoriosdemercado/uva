...
O saldo de empregos na viticultura em `r strftime(atual, format = "%B de %Y")` no Vale do São Francisco é de -70 pessoas, ou seja, o total de contratações (2.213) foi menor do que o total de demissões (2.283). Em relação ao mesmo mês do ano passado, se tem uma piora no saldo total (229 em 2021 e -70 em 2022), pois o número de pessoas que perderam o emprego foi muito maior. 

Dos contratados no mês, 1.127 são do sexo masculino e 1.085 do sexo feminino. Em relação à idade, 14,55% dos contratados tem até 21 anos, 13,15% até 24 anos, 11,16% até 27 anos e 8,81% até 30 anos.

Sobre o nível de escolaridade, a maioria das admissões é de pessoas com ensino médio completo (768). Do total de contratados, 34,70% possuem este nível de escolaridade.

Com relação aos salários pagos, 78,62% dos contratados foram pelo valor de R$ 1.302,00, o salário mínimo nacional. O salário mais elevado foi R\$ 7.295,00.
