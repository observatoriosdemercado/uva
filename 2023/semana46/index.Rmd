...
O preço médio de uva sem semente branca embalada, na semana `r strftime(today, format = "%V")`, foi R\$ 13,27, variando entre R\$14,00 e R\$12,80. Este valor é maior do que a média histórica deflacionada encontrada na semana `r strftime(today, format = "%V")`, que é R\$ 12,21, mais alto do que o preço de 2022 (R\$10,67) e que o preço de 2021 (R\$9,73). Em relação a semana `r strftime(last, format = "%V")`, houve uma redução de -5,89% nos preços.

No caso da uva sem semente negra embalada (embalagem do produtor + resfriamento), na semana `r strftime(today, format = "%V")` o preço médio foi de R\$ 9,87 variando entre R\$ 10,00 e R\$ 9,60. Em 2021, o preço deflacionado é de R\$ 7,59. Em 2022, o preço é de R\$ 7,98 e a média histórica deflacionada para esta semana é de R\$ 10,72. Em relação à semana `r strftime(last, format = "%V")`, os preços aumentaram 1,23%. 

Para a uva sem semente negra, o preço médio na semana `r strftime(today, format = "%V")` é R\$5,84, variando entre R\$6,20 e R\$5,50. Isto significa uma diminuição de -0,68% em relação a semana anterior. Este valor é menor do que a média histórica deflacionada da semana (R\$6,19), mas é maior do que a média de 2022 (R\$ 3,86) e mais alto do que o preço de 2021 deflacionado (R\$ 3,71).
